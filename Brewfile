...
cask "1password"
# Customizable dock, application launcher, dock replacement
cask "activedock"
...
cask "discord"
# Display content in the dock and menu bar
cask "dockx"
...
vscode "ustymukhman.matrix-theme"
